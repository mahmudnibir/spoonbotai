    ...
    <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 md:p-8 border border-stone-200 animate-fade-in-up">
      ...
      <div className="space-y-4">
        ...
        <Step
          ...
          description="Your complete recipe is ready! You can adjust serving sizes, create a categorized shopping list for missing items, and save your favorite recipes to your collection."
        />
      </div>
